...
public class MessageViewController: ChatViewController {
    ...
    public override func didPressSendButton(_ sender: Any?) {
    ...
    public override func didPressGalleryButton(_ sender: Any?) {
    ...
    public override func didSelectVideo(url: URL?) {
        print("URL \(url!)")
    }
    
    public override func didSelectImage(url: URL?) {
        print("URL \(url!)")
